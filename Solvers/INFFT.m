...
% Ni, Hongkang, Rahul Sarkar, Lexing Ying, and Lin Lin. "Inverse nonlinear 
% fast Fourier transform on SU (2) with applications to quantum signal processing." 
% arXiv preprint arXiv:2505.12615 (2025).
